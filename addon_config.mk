...
meta:
	ADDON_NAME = ofxPCA
	ADDON_DESCRIPTION = openFrameworks addon which wraps openCVs PCA (Principal Component Analysis).
	ADDON_AUTHOR = @roymacdonald
	ADDON_TAGS = "addon" "opencv" "PCA"
	ADDON_URL = http://github.com/roymacdonald/ofxPCA
